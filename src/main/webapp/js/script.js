...
function add_to_cart(pid, pname, price)
{
    ...
    if (cart == null) {
        ...
        //no cart yet
        let products = [];
        let product = {producdtId: pid, productName: pname, productQuantity: 1, productPrice: price}
...
//        console.log("Product is added for the first time")
    ...
    } else
    {
        ...
        if (oldProduct) {
            ...
            //we hane to increase thquantity
            oldProduct.productQuantity = oldProduct.productQuantity + 1
            pcart.map((item) => {

                if (item.productId === oldProduct.producdtId)
                {
